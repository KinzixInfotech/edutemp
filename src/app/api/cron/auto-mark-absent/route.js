...
export async function GET(request) {
    ...
    try {
        ...
        console.log(`[CRON] Checking up to: ${endDate.toISOString()} (yesterday)`);
        ...
        return NextResponse.json({
            ...
            dateRange: {
                start: 'Varies per school (based on academic year)',
...
async function processSchool(school, startDate, endDate) {
    ...
    console.log(`[SCHOOL ${school.id}] Found ${calendarCount} total calendar entries in range`);
    ...
    console.log(`[SCHOOL ${school.id}] Found ${workingDays.length} working days in date range`);

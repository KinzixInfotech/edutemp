import { withSchoolAccess } from "@/lib/api-auth"; // Process Payroll API
    ...
    for (const employee of allEmployees) {
      try {
        ...
        if (config.enableProfessionalTax && grossEarnings > 0) {
          ...
          if (grossEarnings > 20000) professionalTax = 200;else
          if (grossEarnings > 15000) professionalTax = 150;else
          if (grossEarnings > 10000) professionalTax = 100;
        }

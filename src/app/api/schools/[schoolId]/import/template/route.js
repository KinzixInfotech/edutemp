...
const MODULE_CONFIGS = {
  students: {
    ...
    { name: 'admissionDate', label: 'Joining Date (YYYY-MM-DD)', required: false, example: '2026-04-01' },
    { name: 'className', label: 'Class Name', required: false, example: 'Class 10' },
    { name: 'sectionName', label: 'Section', required: false, example: 'A' },

...
const MODULE_CONFIGS = {
  students: {
    ...
    { name: 'admissionDate', label: 'Joining Date', type: 'date', required: false, example: '2026-04-01' },
    { name: 'className', label: 'Class Name', type: 'text', required: false, example: 'Class 10' },
    { name: 'sectionName', label: 'Section', type: 'text', required: false, example: 'A' },

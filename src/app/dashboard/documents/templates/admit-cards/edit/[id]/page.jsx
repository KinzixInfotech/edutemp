...
const PLACEHOLDERS = [
    ...
    { value: 'center', label: 'Exam Center' },
    { value: 'venue', label: 'Venue/Room' },
    { value: 'examSchedule', label: 'Exam Schedule (Full Details)' },
    // Individual exam subject placeholders
    { value: 'exam_subject_1', label: '📅 Exam Subject 1 (Full Row)' },
    { value: 'exam_subject_2', label: '📅 Exam Subject 2 (Full Row)' },
    { value: 'exam_subject_3', label: '📅 Exam Subject 3 (Full Row)' },
    { value: 'exam_subject_4', label: '📅 Exam Subject 4 (Full Row)' },
    { value: 'exam_subject_5', label: '📅 Exam Subject 5 (Full Row)' },
    { value: 'studentPhoto', label: 'Student Photo' },
    { value: 'principalSignature', label: 'Principal Signature' },
];

export default function EditAdmitCardTemplatePage() {
    ...
    useEffect(() => {
        if (template) {
            ...
            reset({
                ...
                type: template.type || template.examType || config.defaultType,
                isDefault: template.isDefault,
            });

            // Always set editor config
    ...
    }, [template, reset, config.defaultType]);

...
export default function TeachingStaffPage() {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({ queryKey: ['teaching-staff', schoolId] });
            queryClient.invalidateQueries({ queryKey: ['teaching-staff-designations', schoolId] });
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-5 lg:gap-4">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button
                                ...
                                size="sm"
                                className="bg-muted"
                                onClick={() => queryClient.invalidateQueries({ queryKey: ['teaching-staff', schoolId] })}
                                disabled={isFetching}
                            >

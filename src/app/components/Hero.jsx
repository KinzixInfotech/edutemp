            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12 lg:py-0">
                <div className="w-full max-w-md">
                    ...
                    <div className="space-y-5">
                        ...
                        {/* Input Group */}
                        <div className="flex items-center gap-3 bg-[#f8f9fb] border border-gray-200 rounded-xl px-4 py-4 focus-within:ring-2 focus-within:ring-[#0569ff]/20 focus-within:border-[#0569ff] transition-all">
                            ...
                            <input
                                ...
                                className="flex-1 bg-transparent text-lg font-semibold outline-none text-[#1a1a2e] placeholder:text-gray-400 placeholder:font-normal"
                            />
                        </div>
                        ...
                        >
                            <button
                                className={`group w-full relative px-8 py-4 rounded-xl font-bold text-base transition-all duration-300 overflow-hidden flex items-center justify-center gap-3 ${code
                                    ? 'bg-[#0569ff] text-white shadow-[0_4px_20px_rgba(5,105,255,0.3)] hover:shadow-[0_8px_30px_rgba(5,105,255,0.4)]'
                                    : 'bg-gray-200 text-gray-400 cursor-not-allowed'
                                    }`}
                                disabled={!code}
                            >
                                {code && <span className="absolute inset-0 bg-[#0358dd] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />}

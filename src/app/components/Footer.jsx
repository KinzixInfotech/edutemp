            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-16">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2.5">
                            <li>
                                <a href="mailto:hello@edubreezy.com" className="text-slate-600 hover:text-slate-900 transition-colors text-sm block">
                                    hello@edubreezy.com
                                </a>
                            </li>
                            <li>
                                <a href="tel:+919471532682" className="text-slate-600 hover:text-slate-900 transition-colors text-sm block">
                                    +91 9471 532 682
                                </a>
                            </li>
                            {/* <li className="pt-2">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-8 border-t border-slate-200">
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="w-10 h-10 rounded-full bg-slate-100 hover:bg-slate-200 transition-all duration-300 flex items-center justify-center text-slate-700 hover:scale-110">

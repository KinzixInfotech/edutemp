...
export default function LoginPhoto({ className, ...props }) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-background"> {/* Center wrapper */}
            <div className="relative w-full max-w-4xl flex flex-col p-6 md:p-10">
                            ...
                            {mode ? (
                                <div className="w-full gap-2 h-full flex flex-col items-center justify-center">
                                    <Lottie
                                        ...
                                        loop={true}
                                    />
                                    <span className="text-5xl text-center font-bold capitalize">
                                    ...
                                    <Link href="/schoollogin">
                                        <Button className='mb-3.5 rounded-sm hover:border-black border-2 border-primary transition-all font-bold cursor-pointer hover:bg-muted hover:text-black' size="lg">
                                            Back To Login
                                        </Button>
                                    </Link>
                                </div>

    ...
    if (schoolError) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <pre>
                    {JSON.stringify({ schoolCode, tenantHostDetected, initialSchool }, null, 2)}
                </pre>
                        ...
                        {show2FA ? (
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    className={`group w-full relative h-12 rounded-xl border font-medium text-sm transition-all duration-200 overflow-hidden flex items-center justify-center gap-2 ${googleLoading || loading || alreadyLoggedIn

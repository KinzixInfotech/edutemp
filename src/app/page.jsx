...
function WhyEduBreezySection() {
    const [isVideoOpen, setIsVideoOpen] = useState(false);
    const videoSrc = "https://www.youtube.com/embed/dQw4w9WgXcQ"; // Replace with actual video
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="relative w-full">
                        ...
                        >
                            ...
                            <div className="relative aspect-video rounded-xl overflow-hidden shadow-xl bg-[#1a1a2e] border border-gray-200">
                                <img
                                    src="/dash.png"
                                    alt="EduBreezy Dashboard Demo"
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/20 transition-all">
                                    <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-white flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                        <Play size={24} className="text-[#0569ff] ml-0.5" fill="#0569ff" />
                                    </div>
                                </div>
                                {/* Logo Badge */}
                                <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-sm px-2.5 py-1 rounded-md shadow-md">
                                    <span className="font-bold text-[#1a1a2e] text-xs">edubreezy</span>
                                </div>
                            </div>
                            <p className="text-center text-[#888] text-xs mt-3">
                                Watch how EduBreezy transforms school management
                            </p>
                        </button>
                    </div>
                </div>

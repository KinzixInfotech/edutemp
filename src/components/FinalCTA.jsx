...
export default function FinalCTA() {
    return (
        <section className="relative py-16 md:py-20 px-4 overflow-hidden bg-gradient-to-br from-gray-50 via-slate-50 to-gray-100">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full text-gray-700 text-sm font-medium mb-6 border border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-8">
                    <Link href="/schoollogin">
                        <button className="group flex items-center justify-center gap-2 px-6 py-3 bg-[#0166f6] text-white rounded-full font-semibold transition-all duration-300 hover:bg-[#0152d9] hover:scale-105">
                            Get Started Now
                    ...
                    <Link href="/contact">
                        <button className="group flex items-center justify-center gap-2 px-6 py-3 border-2 border-gray-300 text-gray-700 bg-white rounded-full font-semibold transition-all duration-300 hover:border-gray-400 hover:bg-gray-50 hover:scale-105">
                            Request a Demo
                            <ArrowRight size={18} strokeWidth={2.5} className='transition-transform duration-300 group-hover:translate-x-1' />
                        </button>
                    </Link>

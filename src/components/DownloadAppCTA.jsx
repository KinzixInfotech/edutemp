    ...
    return (
        <section className="relative rounded-2xl bg-gradient-to-b from-[#0569ff] to-[#0041a8] overflow-hidden">
            ...
            <div className="absolute inset-0 z-[5] pointer-events-none overflow-hidden">
                {/* Top Left */}
                <div className="absolute top-[15%] left-[8%] animate-[float_6s_ease-in-out_infinite]">
                    <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/20">
                        <Users className="w-6 h-6 text-white/80" />
                    </div>
                </div>
                {/* Top Right */}
                <div className="absolute top-[12%] right-[10%] animate-[float_7s_ease-in-out_infinite_0.5s]">
                    <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/20">
                ...
                {/* Middle Right */}
                <div className="absolute top-[35%] right-[6%] animate-[float_6s_ease-in-out_infinite_0.3s]">
                    <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/20">
                        <CreditCard className="w-5 h-5 text-white/80" />
                    </div>
                </div>
                {/* Bottom Left */}
                <div className="absolute top-[65%] left-[12%] animate-[float_7s_ease-in-out_infinite_0.8s]">
                    <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/20">
                        <Calendar className="w-5 h-5 text-white/80" />
                    </div>
                </div>
                {/* Bottom Right */}
                <div className="absolute top-[60%] right-[8%] animate-[float_5s_ease-in-out_infinite_0.2s]">
                    <div className="bg-white/10 backdrop-blur-sm p-3 rounded-xl border border-white/20">
